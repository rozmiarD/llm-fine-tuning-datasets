...
|---|---|---|---:|---|
| `debian-admin-bash-sft.v0.6` | [Dataset card](datasets/debian-admin-bash/DATASET_CARD.md) | Debian/Ubuntu admin Bash SFT source records with Bash tooling, incident triage, structured parser, SQLite, backup/restore, SSH/auth, and defensive-admin coverage | 1700 | governed draft dataset |
