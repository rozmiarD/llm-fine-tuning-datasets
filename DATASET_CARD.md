...
|---|---|---|---:|---|
| `debian-admin-bash-sft.v0.5` | [Dataset card](datasets/debian-admin-bash/DATASET_CARD.md) | Debian/Ubuntu admin Bash SFT source records with SQLite, backup/restore, and SSH/auth coverage | 1000 | governed draft dataset |
